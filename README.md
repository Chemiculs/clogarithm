...
int main() {
  ...
  logarithm_resolver.clear_logarithm_engine(); // this needs to be called if you wish to begin searching for logarithms again ( beginning from logarithmic base 2 ) through the same object after calling find_all_logarithmic_bases()
